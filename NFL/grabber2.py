...
import urllib, urllib2, re, time, pprint, csv, codecs, gzip, sys, StringIO, lxml
...
#teams = soup.findAll('a',attrs={'class':'tabletext'})
moneylines = soup.findAll('td',attrs={'class':'viCellBg1'})
#for a in teams:
#	print a.string
for ml in moneylines:
	print repr(ml.td.next_element)
